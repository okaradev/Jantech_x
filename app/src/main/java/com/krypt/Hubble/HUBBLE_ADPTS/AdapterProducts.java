...
import static com.krypt.Hubble.utils.Urls.URL_ADD_CART;
        ...
        view.img_cart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    price = p.getPrice();
                      ...
                      Toast.makeText(ctx, "Please login to add items to shopping cart", Toast.LENGTH_SHORT).show();
                   }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ctx.getApplicationContext(), "error" + e, Toast.LENGTH_SHORT).show();
                            Log.e(TAG, "error2 " + e);
                            progressDialog.dismiss();
                        }
