...
import static com.krypt.Hubble.utils.Urls.URL_SHIPPING;
...
public class Shipping extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Shipping");
    ...
    private void bookings() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_SHIPPING,
