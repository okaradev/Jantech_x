package com.krypt.Hubble.Users.Staff.Driver;

import static com.krypt.Hubble.utils.Urls.URL_MY_RETURN;
...
import com.krypt.Hubble.Users.Staff.Driver.Adaptor.AdptReturn;
import com.krypt.Hubble.Users.Staff.Driver.Model.returnModal;
...
public class MyReturns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_returns);
    ...
    private void bookings() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_MY_RETURN,
