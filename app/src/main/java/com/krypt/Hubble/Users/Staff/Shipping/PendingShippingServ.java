...
import com.krypt.Hubble.Users.Staff.Adaptor.AdptSupers;
...
public class PendingShippingServ extends AppCompatActivity {
    ...
    private void bookings() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PENDING_SERV,
