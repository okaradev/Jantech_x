...
import static com.krypt.Hubble.utils.Urls.URL_SUPERVISOR;
...
import com.krypt.Hubble.HUBBLEMODELS.DriversModel;
import com.krypt.Hubble.HUBBLE_ADPTS.AdapterDrivers;
...
public class Supers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Supervisors");
    ...
    private void techs() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_SUPERVISOR,
