...
import static com.krypt.Hubble.utils.Urls.URL_RETURNED;
...
public class Returned extends AppCompatActivity {
    ...
    private void bookings() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_RETURNED,
