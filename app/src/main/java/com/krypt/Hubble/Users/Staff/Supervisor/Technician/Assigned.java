package com.krypt.Hubble.Users.Staff.Supervisor.Technician;

import static com.krypt.Hubble.utils.Urls.URL_ASSIGNMENT_TECH;
...
public class Assigned  extends AppCompatActivity {
    ...
    private void bookings() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ASSIGNMENT_TECH,
