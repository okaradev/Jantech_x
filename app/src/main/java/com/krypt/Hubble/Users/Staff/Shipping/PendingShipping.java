...
import static com.krypt.Hubble.utils.Urls.URL_PENDING_DELI;
...
public class PendingShipping extends AppCompatActivity {
...
//        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Toast.makeText(PendingShipping.this, msg, Toast.LENGTH_SHORT).show();
    ...
    private void loadProgrammes() {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adptBookings = new AdptBookings(PendingShipping.this, list);
        ...
        Volley.newRequestQueue(PendingShipping.this).add(stringRequest);
    }
