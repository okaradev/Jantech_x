...
import static com.krypt.Hubble.utils.Urls.GET_STOCK;
import static com.krypt.Hubble.utils.Urls.GET_STOCK_SUPPLIER;
...
import com.krypt.Hubble.Users.Staff.Store_man.Adaptor.AdapterStoreItems;
import com.krypt.Hubble.Users.Staff.Store_man.Adaptor.AdapterStoreItemsSup;
import com.krypt.Hubble.Users.Staff.Store_man.Model.StoreItemModal;
import com.krypt.Hubble.databinding.FragmentHomeBinding;
...
public class AddStockSupplier extends AppCompatActivity {
    private FragmentHomeBinding binding;
    private SessionHandler session;
    private UserModel user;
    private List<StoreItemModal> list;
    private AdapterStoreItemsSup adapterProducts;
    ...
    public void getProdcuts() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_STOCK_SUPPLIER,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                adapterProducts = new AdapterStoreItemsSup(getApplicationContext(), list);
