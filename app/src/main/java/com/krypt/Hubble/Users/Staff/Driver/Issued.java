...
import static com.krypt.Hubble.utils.Urls.URL_ISSUED;
...
public class Issued extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Issued");
    ...
    private void bookings() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ISSUED,
