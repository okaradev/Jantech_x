...
import static com.krypt.Hubble.utils.Urls.URL_APPROVED_FINES_PAY;
...
public class FineHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Approved fine payments");
    ...
    private void getFines() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_APPROVED_FINES_PAY,
