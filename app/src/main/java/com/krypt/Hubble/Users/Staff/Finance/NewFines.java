...
import static com.krypt.Hubble.utils.Urls.URL_NEW_FINES;
...
import com.krypt.Hubble.Users.Staff.Supervisor.Adaptor.AdptFines;
import com.krypt.Hubble.Users.Staff.Supervisor.Model.FinesModel;
...
public class NewFines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("New service fee pending approval");
    ...
    private void getFines() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_NEW_FINES,
