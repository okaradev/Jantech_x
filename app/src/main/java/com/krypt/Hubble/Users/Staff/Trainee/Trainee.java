package com.krypt.Hubble.Users.Staff.Trainee;

import static com.krypt.Hubble.utils.Urls.URL_TRAINEE;
...
public class Trainee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Trainees");
    ...
    private void drivers() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_TRAINEE,
