...
import static com.krypt.Hubble.utils.Urls.URL_PENDING_SERV;
import static com.krypt.Hubble.utils.Urls.URL_PENDING_TECH;
...
import com.krypt.Hubble.Users.Staff.Adaptor.AdptTechs;
...
public class PendingShippingTechs extends AppCompatActivity {

    private RecyclerView recyclerView;
    private ProgressBar progressBar;
    private List<BookingModal> list;
    private AdptTechs adptBookings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Assign Technician");
    ...
    private void bookings() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PENDING_TECH,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                adptBookings = new AdptTechs(getApplicationContext(), list);
