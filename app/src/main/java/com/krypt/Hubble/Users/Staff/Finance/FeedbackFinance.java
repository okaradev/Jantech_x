package com.krypt.Hubble.Users.Staff.Finance;


import static com.krypt.Hubble.HUBBLE_ADPTS.AdapterFeedbackService.myfb;
import static com.krypt.Hubble.utils.Urls.URL_FBACK;
...
import com.krypt.Hubble.HUBBLEMODELS.FeedbackModelServices;
import com.krypt.Hubble.HUBBLE_ADPTS.AdapterFeedback;
import com.krypt.Hubble.HUBBLE_ADPTS.AdapterFeedbackService;
import com.krypt.Hubble.R;
import com.krypt.Hubble.utils.SessionHandler;
import com.krypt.Hubble.utils.Urls;
...
public class FeedbackFinance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedback_finance);
...
//
    ...
    public void getFeedback() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.URL_FBACK,
                        ...
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    FeedbackModel feedbackModel = new FeedbackModel(id,comment,reply);
                                ...
                                Toast.makeText(FeedbackFinance.this, msg, Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);
                            }

                        } catch (Exception e) {
                            e.printStackTrace();
                            Toast.makeText(FeedbackFinance.this, e.toString(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(FeedbackFinance.this, error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void send() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Urls.URL_SENF_FEEDBACK,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
